...
const Login = ({ onLoginSuccess }: LoginProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-primary/20 via-secondary/10 to-accent/20 flex items-center justify-center p-4 z-50">
      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl border-primary/20">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-3xl font-bold text-primary">FestHub</CardTitle>
