        ...
        <div className="flex flex-col justify-center items-center text-center min-h-screen pt-20">
          ...
          <div className="flex justify-center items-center gap-4 mb-8">
            <img 
              ...
              alt="FestHub Logo" 
              className="h-[120px] w-[120px] shadow-gold border-2 border-[hsl(207_90%_54%)] rounded-full"
            />
            <img 
          ...
          <div className="space-y-6 mb-8">
            ...
            <p className="text-2xl italic text-gray-900 mb-12 opacity-90"
          ...
          <div className="flex flex-wrap justify-center items-stretch gap-8 mt-8">
            {tabCards.map((card) => (
              <div
                ...
                className="bg-white border-2 border-[hsl(194_100%_91%)] rounded-2xl p-8 text-center cursor-pointer transition-all duration-300 hover:transform hover:-translate-y-3 hover:border-[hsl(45_93%_47%)] hover:shadow-elegant relative overflow-hidden min-w-[280px] flex-1 max-w-[320px]"
                style={{ boxShadow: '0 4px 16px rgba(33, 150, 243, 0.07)' }}
              >
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[hsl(207_90%_54%)] to-[hsl(45_93%_47%)] transform scale-x-0 transition-transform duration-300 hover:scale-x-100"></div>
